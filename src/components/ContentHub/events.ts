...
export const calendarEvents: CalendarEvent[] = [
  ...
  { day: 6, month: 2, year: 2026, title: "EXPERIÊNCIA", description: "15:00; Anti Ribeiro, Nãovenhasemrosto, Pek0", eventSubtitle: "Anti Ribeiro, Nãovenhasemrosto, Pek0", hora: "15:00", fullDescription: "Experiência de escuta com Anti Ribeiro, Nãovenhasemrosto e Pek0 \n intermediação sonora: numa gama \n contribua no link abaixo ", local: "Vão Livre (MAM-Rio)", image: "/espaco.png", linkText: "SAIBA MAIS", link: "https://shotgun.live/en/events/campo-esquerdo-ii" },
  { day: 17, month: 6, year: 2026, title: "NOITES DE DUB", description: "Campo Esquerdo Soundsystem @ trauma", eventSubtitle: "Capetini + numa gama", hora: "22:00", fullDescription: "Residência da Doblado Records no Trauma RJ dedicada a articular a cultura sound system com a rave e o club, evidenciando as sonoridades e técnicas de produção que são inDUBitavelmente alicerces para a música eletrônica como a gente conhece hoje", local: "TRAUMA", image: "https://tactful-crab.staticdomains.app/58cd7f95e72dbaf25db9b23c4724b7a4.jpeg", linkText: "ANTECIPADOS", link: "https://shotgun.live/pt-br/events/noites-de-dub-convida-numa-gama-campo-esquerdo-sound-syrem" },
];
